...
const Dashboard = () => {
    ...
    return (
        <div className=''>
            <Title align="left" title="Dashboard" subTitle="Monitor your room listings, track bookings, and analyze revenue - all in one place. Stay updated with real-time insights to ensure smooth operations." font="Poppins"/>
            ...
            <div className='flex flex-col gap-4 my-8'>
                ...
                <h2 className='text-xl text-blue-950/70 font-medium mt-5'>Recent Bookings</h2>
                <div className='w-full max-w-3xl text-left border border-gray-300 rounded-lg max-h-80 overflow-y-scroll '>
                    <table className='w-full'>
                        ...
                        <tbody className='text-sm'>
                            {
                                dashboardData.bookings.map((item, key) => (
                                    <tr key={key}>
