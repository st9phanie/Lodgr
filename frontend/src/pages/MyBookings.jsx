    ...
    return (
        <div className="py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32">
            ...
            <div className="max-w-6xl mt-8 w-full text-gray-800">
                ...
                {bookings.map((item) => (
                    <div key={item._id} className="grid grid-cols-1 md:grid-cols-[3fr_2fr_1fr] w-full border-b border-gray-300 py-6 first:border-t">
                        <div className="flex flex-col md:flex-row">
                            <img src={item.room.images[0]} alt="room image" className="min-md:w-44 rounded shadow object-cover" />
                            <div className="flex flex-col gap-1.5 max-md:mt-3 min-md:ml-4">
                                <p className="playfair text-2xl">{item.hotel.name}
